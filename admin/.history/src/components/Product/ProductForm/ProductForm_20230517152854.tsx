    ...
    <div className={styles.productForm}>
        ...
        <div className={`${styles.container} ${styles.locationAndDuration}`}>
            ...
            <div className={styles.duration}>
              ...
              <input  value={durationNights} onChange={handleDurationNights} type="text" placeholder=''/>
              <span className={styles.title}>박</span>
              <input value={durationDays} onChange={handleDurationDays} type="text" placeholder=''/>
