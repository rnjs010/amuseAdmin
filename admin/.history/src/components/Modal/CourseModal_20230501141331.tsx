...
function CourseModal({onSave, onToggle}: MordalProps) {
  ...
  const handleTimeCost = (event: React.ChangeEvent<HTMLTextAreaElement>) => {
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.body}>
          ...
          <div className={`${styles.container} ${styles.title}`}>
            ...
            <input className={`${styles.input} ${styles.title}`} value={timeCost} onChange={handleTimeCost} type="text" />
          </div>
