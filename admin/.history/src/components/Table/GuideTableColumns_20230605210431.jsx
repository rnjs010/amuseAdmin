...
import { GuideTableCloumns } from '../../components/Table/GuideTableCloumns';

export const getGuideInfo = (setAllGuide) => {
    axios.get(`https://ammuse.store/test/api/list/guide?page=1&limit=200`)
      .then((res) => {
        console.log(res);
...
export default GuideTableCloumns