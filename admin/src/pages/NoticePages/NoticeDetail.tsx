...
const NoticeDetail = () => {
  ...
  const editNotice = () => {
    (async () => {
      await axios
        .post(`${process.env.REACT_APP_AMUSE_API}/test/api/notice/edit`, {
          id: id,
          title: title,
  ...
  useEffect(() => {
    (async () => {
      await axios.get(`${process.env.REACT_APP_AMUSE_API}/test/api/notice/${id}`).then((r) => {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.body}>
        <div onSubmit={() => console.log("onSubmit")}>
