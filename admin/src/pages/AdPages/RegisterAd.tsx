...
const RegisterAd = () => {
	...
	const registerAd = async () => {
		...
		if(title == null) window.confirm("제목을 다시 확인해주세요");
		
		if(startDate == null || endDate == null) window.confirm("날짜를 다시 확인해주세요");
			...
			<div className={styles.body}>
				<div className={styles.adEditorContainer}>
					...
					<div className={styles.adEditorContainerElement}>
						광고제목
						<input className={styles.adEditorContainerAdTitleInput}  onChange={e => setTitle(e.target.value)}/>
					</div>
