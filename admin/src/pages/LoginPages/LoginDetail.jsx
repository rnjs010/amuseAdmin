        ...
        <div className="v_box">
          <div className="OAuth">
            <a
              ...
              href={`https://amuseapi.wheelgo.net/oauth2/authorization/google?redirect_uri=${redirectU}`}
            >
              <GoogleIcon sx={{ mr: 4 }} />
              Google 로그인
            </a>
            <a
              ...
              href={`https://amuseapi.wheelgo.net/oauth2/authorization/naver?redirect_uri=${redirectU}`}
            >
              <img
            ...
            <a
              ...
              href={`https://amuseapi.wheelgo.net/oauth2/authorization/kakao?redirect_uri=${redirectU}`}
            >
              <img
